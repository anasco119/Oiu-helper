        ...
        # ============================
            ...
            if msg.content_type == "text":
                ...
                for step in processing_steps:
                    step_msg = bot.edit_message_text(step, chat_id=chat_id, message_id=message_id, parse_mode="Markdown")
                ...
                try:
                    ...
                    quiz_msg = f"""
                       ...
                       <b>تم توليد الاختبار بنجاح.</b>
                        ...
                        """
                    bot.edit_message_text(chat_id=chat_id, message_id=message_id, text=quiz_msg)
                    with state_lock:
                        user_states.pop(uid, None)
